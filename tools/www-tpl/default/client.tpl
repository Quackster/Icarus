...
<head>
    ...
    <link rel="shortcut icon" href="http://icarus.dev/favicon.ico" type="image/vnd.microsoft.icon" />
    <link rel="stylesheet" href="http://icarus.dev/web-gallery/static/styles/common.css" type="text/css" />
    <script src="http://icarus.dev/web-gallery/static/js/libs2.js" type="text/javascript"></script>
    <script src="http://icarus.dev/web-gallery/static/js/visual.js" type="text/javascript"></script>
    <script src="http://icarus.dev/web-gallery/static/js/libs.js" type="text/javascript"></script>
    <script src="http://icarus.dev/web-gallery/static/js/common.js" type="text/javascript"></script>
    <script type="text/javascript">
        document.habboLoggedIn = true;
        var habboReqPath = "";
        var habboStaticFilePath = "http://icarus.dev/web-gallery/";
        var habboImagerUrl = "http://icarus.dev/habbo-imaging/";
        var habboPartner = "";
    ...
    <link rel="stylesheet" href="http://icarus.dev/web-gallery/styles/habboflashclient.css" type="text/css" />
    <script src="http://icarus.dev/web-gallery/static/js/habboflashclient.js" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        var flashvars = {
            ...
            "site.url": "http://icarus.dev/",
            "url.prefix": "http://icarus.dev",
            "client.reload.url": "/disconnected",
            "client.fatal.error.url": "http://icarus.dev/disconnected",
            "client.connection.failed.url": "http://icarus.dev/disconnected",
            "external.variables.txt": "http://icarus.dev/gamedata/external_variables.txt?version=1508874234",
            "external.texts.txt": "http://icarus.dev/gamedata/external_flash_texts.txt?version=1508874234",
            "external.override.texts.txt": "http://icarus.dev/gamedata/override/external_flash_override_texts.txt?version=1508874234",
            "external.override.variables.txt": "http://icarus.dev/gamedata/override/external_override_variables.txt?version=1508874234",
            "productdata.load.url": "http://icarus.dev/gamedata/productdata.txt",
            "furnidata.load.url": "http://icarus.dev/gamedata/furnidata.xml",
            "use.sso.ticket": "1",
            "sso.ticket": "123",
            ...
            "flash.client.url": "http://icarus.dev/gordon/PRODUCTION-201710172204-432325793/",
            "user.hash": "{{ sso-ticket }}",
            "has.identity": "0",
        ...
        var params = {
            "base": "http://icarus.dev/gordon/PRODUCTION-201710172204-432325793/",
        ...
        var clientUrl = "http://icarus.dev/gordon/PRODUCTION-201710172204-432325793/Habbo.swf?version=1508874234";
